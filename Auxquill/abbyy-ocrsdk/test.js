...
var imagePath = 'wimage.png';
var outputPath = 'wimage-result.rtf'
...
try {
    ...
    settings.exportFormat = "rtf"; //"txt"; // All possible values are listed in 'exportFormat' parameter description 
